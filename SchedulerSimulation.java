...
public class SchedulerSimulation {
    // Feature 2: Static counter variable for context switches
    public static int contextSwitches = 0;

    public static void main(String[] args) {
        // ⚠️ IMPORTANT: Put your student ID here to seed the random number generator
        // This makes your output unique to you - DO NOT forget to change this!
        int studentID = 445050186; // ← CHANGE THIS TO YOUR ACTUAL STUDENT ID
        ...
        for (int i = 1; i <= numProcesses; i++) {
            ...
            // Feature 1: Generate random priorities (1-5)
            int priority = 1 + random.nextInt(5);
            // Create a new process object with a unique name, burst time, and the defined
            // time quantum
            Process process = new Process("P" + i, burstTime, timeQuantum, priority);// Feature 1: Pass priority to the
                                                                                     // constructor
        ...
        // Feature 2: Display total context switches at the end
    ...
    public static void addProcessToQueue(Process process, Queue<Thread> processQueue,
        ...
        // Feature 1: Modified print statement to display the generated priority
